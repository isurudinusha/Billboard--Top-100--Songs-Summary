...
def top_ranked_songs(data):
    ...
    print("")
    print("Number of records: ",len(toprankedsongs))


def top_ranked_songs_artist(data):
    """
    It filters the data to only include songs that have a rank of 1, then it loops through the filtered
    data and prints the song and artist for each song that has a rank of 1. It also keeps track of the
    number of songs that have a rank of 1 and prints that number at the end
    ...
    uniquesonglist = []
    for songs in toprankedsongs:
        if songs["song"] not in uniquesonglist:
            uniquesonglist.append(songs["song"])
            print(songs["song"],"-", songs["artist"]) 
    print("")
    print("Number of records: ",len(uniquesonglist))        
...
def songs_with_the_longest_number_of_weeks_on_the_board(data):
    ...
    for songs in longestnumberofweekssongs:
        if songs["song"] not in uniquesonglist and len(uniquesonglist) != 10:
            uniquesonglist.append(songs["song"])
            print(songs["song"], "-",songs["weeks-on-board"],"weeks" )
    print("")
    print("Number of records: ",len(uniquesonglist)) 
...
def song_moved_the_most_in_ranking_on_the_board(data):
    ...
    print("Song Name: ", sortedlist[0][0], "\nNumber of times rank changed:", sortedlist[0][1])
    # print(marklist)
...
def main():
    """
    It opens the csv file, reads it, and appends it to a list.
    """
    print("Loading!!!")
